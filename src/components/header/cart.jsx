  ...
  return (
    <>
      <div
        ...
        className={`bg-overlay h-full fixed z-30 right-0 top-0 transition-all w-full ${
          cartActive ? " visible" : "invisible"
        }`}
      ></div>
      <div
        className={`bg-background 2sm:px-17.5 px-5 2sm:py-30 py-16 max-w-[552px] max-h-screen min-h-screen overflow-y-auto w-full fixed z-40 top-0 transition-all duration-700 ${
          cartActive ? "right-0" : "-right-full"
        }`}
      >
        <div className="flex justify-between items-center">
          ...
          <p className="text-xl font-bold cursor-pointer text-primary-foreground" onClick={() => setCartActive(false)}>
            Close (X)
          </p>
        </div>
                    ...
                    <div className="flex items-center gap-6">
                      ...
                      <div>
                        ...
                        <span className="text-lg inline-block text-primary-foreground">
                          Qty <span className="font-bold text-xl inline-block ml-[22px]">{quantity}</span>{" "}
                        </span>
                      </div>
                    </div>
                    <div>
