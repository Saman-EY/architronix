          ...
          <div className="grid xl:grid-cols-[auto_538px] lg:grid-cols-[auto_350px] md:grid-cols-[auto_400px] 2xl:gap-[132px] gap-16 items-start">
            <div>
              <div className="mb-12.5">
                ...
                <p>
                  Russell Otten, the Interior Alchemist at Architronix, adds a touch of magic to spaces. With over a
                  decade of experience, Russell blends artistic flair with a deep understanding of client aspirations.
                </p>
              </div>
              <div className="pt-12.5">
                ...
                <ul>
                  ...
                  <li className="pt-7.5">
                    ...
                    <p className="mt-2.5 xl:ml-[113px] 2sm:ml-14 ml-10">
                      His expertise lies in creating a timeless interiors that seamlessly blend luxury and
                      functionality.
                    </p>
                  </li>
                </ul>
              ...
              <div className="pt-20">
                ...
                <ul>
                  <li>
                    ...
                    <p className="mt-2.5 xl:ml-[113px] 2sm:ml-14 ml-10">
                      Russell's design philosop Architronix revolves around capturing the essence of each client's
                      persionality and translating it into a space that feels uniquely theirs.
                    </p>
                  </li>
                  <li className="pt-7.5">
                    <h5 className="font-bold">Client-Centric Approach: </h5>
                    <p className="mt-2.5 xl:ml-[113px] 2sm:ml-14 ml-10">
                      Through close collaboration, Russell ensures that a every design reflects the client's vision and
              ...
              <div className="pt-20">
                ...
                <ul>
                  ...
                  <li className="pt-7.5">
                    ...
                    <p className="mt-2.5 xl:ml-[113px] 2sm:ml-14 ml-10">
                      Recognized as an the industry leader, Russell is a member of the National Interior Design for
                      Association (NIDA) and has received accolades for his innovative designs.
                    </p>
                  </li>
                </ul>
              </div>
              <div className="pt-20">
                ...
                <ul>
                  <li>
                    ...
                    <p className="mt-2.5 xl:ml-[113px] 2sm:ml-14 ml-10">
                      Russell Otten's work at Architronix has been feeatured in Design Excellence Magazine, earning him
                      the Interior Alchemist title.
                    </p>
                  </li>
                </ul>
              </div>
              <div className="pt-20">
                ...
                <ul>
                  <li className="flex items-center mb-3">
                    ...
                    <Link href={"mailto:russell@architronix.com"} className="hover-underline">
